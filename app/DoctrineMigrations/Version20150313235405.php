 ...
 */
class Version20150313235405 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE Operateur (id INT AUTO_INCREMENT NOT NULL, booking_id INT DEFAULT NULL, commande_id INT DEFAULT NULL, user_id INT NOT NULL, action VARCHAR(255) NOT NULL COMMENT \'1:note, 2:confirmer, 3:acompte, 4:facturer, 5:avis\', date_time DATETIME NOT NULL, ip VARCHAR(255) NOT NULL, INDEX IDX_36467B3EA76ED395 (user_id), INDEX IDX_36467B3E82EA2E54 (commande_id), INDEX IDX_36467B3E3301C60 (booking_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
