...
class BookingData extends AbstractFixture implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $booking2->setUser($this->getReference('user1'));
        ...
        $booking3->setUser($this->getReference('user1'));
        ...
        $booking4->setUser($this->getReference('user1'));
        ...
        $booking5->setUser($this->getReference('user1'));
        ...
        $booking6->setUser($this->getReference('user1'));
        $booking6->setSortie($this->getReference('sortie1'));
        ...
        $booking7->setUser($this->getReference('user1'));
        $booking7->setSortie($this->getReference('sortie1'));
        ...
        $booking8->setUser($this->getReference('user1'));
        $booking8->setSortie($this->getReference('sortie1'));
        ...
        $booking9->setUser($this->getReference('user1'));
        $booking9->setSortie($this->getReference('sortie1'));
        ...
        $booking10->setUser($this->getReference('user1'));
        $booking10->setSortie($this->getReference('sortie1'));
        ...
        $booking10->setFacture('');
        $booking10->setAcompte('');
        $booking10->setMandat('');
        ...
        $booking11->setUser($this->getReference('user1'));
        $booking11->setSortie($this->getReference('sortie1'));
        ...
        $booking11->setFacture('');
        $booking11->setAcompte('');
        $booking11->setMandat('');
        ...
        $booking12->setUser($this->getReference('user1'));
        $booking12->setSortie($this->getReference('sortie1'));
        ...
        $booking12->setFacture('');
        $booking12->setAcompte('');
        $booking12->setMandat('');
        ...
        $booking13->setUser($this->getReference('user1'));
        $booking13->setSortie($this->getReference('sortie1'));
        ...
        $booking13->setFacture('');
        $booking13->setAcompte('');
        $booking13->setMandat('');
        ...
        $booking14->setUser($this->getReference('user1'));
        $booking14->setSortie($this->getReference('sortie1'));
        ...
        $booking14->setFacture('');
        $booking14->setAcompte('');
        $booking14->setMandat('');
        ...
        $booking15->setUser($this->getReference('user1'));
        $booking15->setSortie($this->getReference('sortie1'));
        ...
        $booking15->setFacture('');
        $booking15->setAcompte('');
        $booking15->setMandat('');
        ...
        $booking16->setSortie($this->getReference('sortie1'));
        ...
        $booking16->setFacture('');
        $booking16->setAcompte('');
        $booking16->setMandat('');
        ...
        $booking17->setUser($this->getReference('user1'));
        $booking17->setSortie($this->getReference('sortie1'));
        ...
        $booking17->setFacture('');
        $booking17->setAcompte('');
        $booking17->setMandat('');
        ...
        $booking18->setUser($this->getReference('user1'));
        $booking18->setSortie($this->getReference('sortie1'));
        ...
        $booking18->setFacture('');
        $booking18->setAcompte('');
        $booking18->setMandat('');
