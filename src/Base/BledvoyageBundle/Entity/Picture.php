 ...
 * Picture
 *
 * @ORM\Table(name="bledvoyage__Picture")
 * @ORM\Entity(repositoryClass="Base\BledvoyageBundle\Entity\PictureRepository")
...
class Picture
{
     ...
     * Le constructeur
     * 
     * Juste pour un essai, j'ai ajouté ces valeurs intiniales
     */
